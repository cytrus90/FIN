...
class listSplitVC: UISplitViewController, UISplitViewControllerDelegate {
...
//        let masterMC = (self.viewControllers.first as? UINavigationController)?.viewControllers.first as? listMasterTVC
